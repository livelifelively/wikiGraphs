...
(function() {
  ...
  var log = function() {
	// CUSTOM : a backbone collection variable here to detect and update the user about the progress.
    log.history = Kinvey.history = log.history || []; // Store logs to an array for reference.
