 ...
 */
define(['jquery', 'vendor/underscore', 'kinvey'], function($, _, Kinvey) {
  /*
  ...
  return {
	...
	ensureLogin: function(){
		...
		// true : reload to go to the member home page.
		// false : reload to go to the general home page with sign up option.
